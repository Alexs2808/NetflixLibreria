            ...
            <div class="col-lg-2">
                <div class="sidebar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#" id="finishedLink">
            ...
            <div class="col-lg-10">
                <div class="main-content">
                        ...
                        <div class="col-md-8">
                            <div class="reading-stats">
                                ...
                                <div class="d-flex justify-content-between">
                                    <small>Meta: ${metaAnual}</small>
                                    <small>${librosCompletadosAnual} completados</small>
                                </div>
                                <div class="progress-bar-custom mt-2">
                                    <div class="progress-fill" style="width: ${(librosCompletadosAnual / metaAnual) * 100}%"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="reading-stats">
                                ...
                                <c:forEach items="${generosMasLeidos}" var="genero" varStatus="loop">
                                    <c:if test="${loop.index < 3}">
                                        <div class="mb-2">
                                            <div class="d-flex justify-content-between mb-1">
                                                <span>${genero.nombre}</span>
                                                <span>${genero.cantidad}</span>
                                            </div>
                                            <div class="progress-bar-custom">
                                                <div class="progress-fill" style="width: ${(genero.cantidad / maxGeneros) * 100}%"></div>
                                            </div>
                                        </div>
                                    </c:if>
                                </c:forEach>
                    ...
                    <div class="row g-4" id="finishedGrid">
                        <c:forEach items="${librosTerminados}" var="libro">
                            <div class="col-lg-4 col-md-6">
                                <div class="book-card">
                                    <div class="book-cover" style="background-color: ${libro.color};">
                                        ...
                                        <i class="bi bi-check-circle-fill finished-badge"></i>
                                        <div class="book-actions">
                                            <button class="action-btn ${libro.esFavorito ? 'active' : ''}" title="${libro.esFavorito ? 'Quitar de favoritos' : 'Añadir a favoritos'}">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="rating-stars">
                                                <c:forEach begin="1" end="5" var="i">
                                                    <i class="bi ${i <= libro.calificacion ? 'bi-star-fill' : 'bi-star'}"></i>
                                                </c:forEach>
                                            </div>
                                        </div>
                                    </div>
